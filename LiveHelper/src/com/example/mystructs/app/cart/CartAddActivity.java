...
public class CartAddActivity extends Activity implements OnClickListener   {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cart_add);
		radioGroup=(RadioGroup)findViewById(R.id.cart_add_group);
		title=(EditText)findViewById(R.id.cart_add_title);
		money=(EditText)findViewById(R.id.cart_add_money);
		date=(TextView)findViewById(R.id.cart_add_date);
		date_bt=(ImageView)findViewById(R.id.cart_add_date_bt);
		special=(CheckBox)findViewById(R.id.cart_add_special);
		account=(CheckBox)findViewById(R.id.cart_add_account);
		forgive=(ImageView)findViewById(R.id.cart_add_forgive);
		save=(ImageView)findViewById(R.id.cart_add_save);
		...
		radioGroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				// TODO Auto-generated method stub
				switch (checkedId) {
				case R.id.cart_add_group_lone:
					RadioTag=0;
					break;
				case R.id.cart_add_group_more:
					RadioTag=1;
					break;
				default:
					break;
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		switch (v.getId()) {
		case R.id.cart_add_date_bt:
			showDialog(Constant.DIALOG_ID_0);
			break;
		case R.id.cart_add_forgive:
			finish();
			break;
		case R.id.cart_add_save:
	...
	protected Dialog onCreateDialog(int id) {
		...
		case Constant.DIALOG_ID_0:
			return new DatePickerDialog(CartAddActivity.this, onDateSetListener, 2013, 1, 20);
		default:
			break;
		}
	...
	private boolean addCart(){
		...
		contentValues.put(DB.Consump_Column1, RadioTag);
		contentValues.put(DB.Consump_Column2, titleTag);
		contentValues.put(DB.Consump_Column3, moneyTag);
		contentValues.put(DB.Consump_Column4, dateTag);
		contentValues.put(DB.Consump_Column5, SpecialTag);
		contentValues.put(DB.Consump_Column6, AccountTag);
		Uri uri=this.getContentResolver().insert(Constant.CONTENT_URI_Consump, contentValues);
